...
public class FormHandlerServlet extends HttpServlet {
  ...
  private static String uploadToCloudStorage(String fileName, InputStream fileInputStream) {
    String projectId = "marlongamez-sps-spring21";
    String bucketName = "marlongamez-sps-spring21.appspot.com";
    Storage storage =
        StorageOptions.newBuilder().setProjectId(projectId).build().getService();
    BlobId blobId = BlobId.of(bucketName, getUniqueFileName(fileName));
  ...
  private static String getUniqueFileName(String ogFileName) {
    return ogFileName + "-" + UUID.randomUUID().toString();
  }
}
